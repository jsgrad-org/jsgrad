...
import { vars, import_beam } from '@jsgrad/jsgrad'
    ...
    <div className="flex flex-col h-screen w-screen justify-between overflow-hidden p-3 md:p-10">
      ...
      <div className="flex flex-col gap-2 pt-1">
        ...
        >
          ...
          <button disabled={!model || !!progress} className="h-12 w-16 bg-white text-black flex items-center justify-center rounded-xl disabled:bg-white/70" type="submit">
