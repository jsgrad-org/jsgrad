import { cache, env } from '../base.ts'

// Clip tokenizer, taken from https://github.com/openai/CLIP/blob/main/clip/simple_tokenizer.py (MIT license)
const default_bpe = cache(() => env.fetchSave('https://github.com/openai/CLIP/raw/main/clip/bpe_simple_vocab_16e6.txt.gz', 'bpe_simple_vocab_16e6.txt.gz'))
