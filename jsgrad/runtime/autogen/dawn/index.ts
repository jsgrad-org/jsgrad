...
class SupportedLimits implements GPUSupportedLimits {
  ...
  get maxTextureDimension1D() { return this._supportedLimits.$limits.$maxTextureDimension1D.value }
  get maxTextureDimension2D() { return this._supportedLimits.$limits.$maxTextureDimension2D.value }
  get maxTextureDimension3D() { return this._supportedLimits.$limits.$maxTextureDimension3D.value }
  get maxTextureArrayLayers() { return this._supportedLimits.$limits.$maxTextureArrayLayers.value }
  get maxBindGroups() { return this._supportedLimits.$limits.$maxBindGroups.value }
  get maxBindGroupsPlusVertexBuffers() { return this._supportedLimits.$limits.$maxBindGroupsPlusVertexBuffers.value }
  get maxBindingsPerBindGroup() { return this._supportedLimits.$limits.$maxBindingsPerBindGroup.value }
  get maxDynamicUniformBuffersPerPipelineLayout() { return this._supportedLimits.$limits.$maxDynamicUniformBuffersPerPipelineLayout.value }
  get maxDynamicStorageBuffersPerPipelineLayout() { return this._supportedLimits.$limits.$maxDynamicStorageBuffersPerPipelineLayout.value }
  get maxSampledTexturesPerShaderStage() { return this._supportedLimits.$limits.$maxSampledTexturesPerShaderStage.value }
  get maxSamplersPerShaderStage() { return this._supportedLimits.$limits.$maxSamplersPerShaderStage.value }
  get maxStorageBuffersPerShaderStage() { return this._supportedLimits.$limits.$maxStorageBuffersPerShaderStage.value }
  get maxStorageTexturesPerShaderStage() { return this._supportedLimits.$limits.$maxStorageTexturesPerShaderStage.value }
  get maxUniformBuffersPerShaderStage() { return this._supportedLimits.$limits.$maxUniformBuffersPerShaderStage.value }
  get maxUniformBufferBindingSize() { return Number(this._supportedLimits.$limits.$maxUniformBufferBindingSize.value) }
  get maxStorageBufferBindingSize() { return Number(this._supportedLimits.$limits.$maxStorageBufferBindingSize.value) }
  get minUniformBufferOffsetAlignment() { return this._supportedLimits.$limits.$minUniformBufferOffsetAlignment.value }
  get minStorageBufferOffsetAlignment() { return this._supportedLimits.$limits.$minStorageBufferOffsetAlignment.value }
  get maxVertexBuffers() { return this._supportedLimits.$limits.$maxVertexBuffers.value }
  get maxBufferSize() { return Number(this._supportedLimits.$limits.$maxBufferSize.value) }
  get maxVertexAttributes() { return this._supportedLimits.$limits.$maxVertexAttributes.value }
  get maxVertexBufferArrayStride() { return this._supportedLimits.$limits.$maxVertexBufferArrayStride.value }
  get maxInterStageShaderComponents() { return this._supportedLimits.$limits.$maxInterStageShaderComponents.value }
  get maxInterStageShaderVariables() { return this._supportedLimits.$limits.$maxInterStageShaderVariables.value }
  get maxColorAttachments() { return this._supportedLimits.$limits.$maxColorAttachments.value }
  get maxColorAttachmentBytesPerSample() { return this._supportedLimits.$limits.$maxColorAttachmentBytesPerSample.value }
  get maxComputeWorkgroupStorageSize() { return this._supportedLimits.$limits.$maxComputeWorkgroupStorageSize.value }
  get maxComputeInvocationsPerWorkgroup() { return this._supportedLimits.$limits.$maxComputeInvocationsPerWorkgroup.value }
  get maxComputeWorkgroupSizeX() { return this._supportedLimits.$limits.$maxComputeWorkgroupSizeX.value }
  get maxComputeWorkgroupSizeY() { return this._supportedLimits.$limits.$maxComputeWorkgroupSizeY.value }
  get maxComputeWorkgroupSizeZ() { return this._supportedLimits.$limits.$maxComputeWorkgroupSizeZ.value }
  get maxComputeWorkgroupsPerDimension() { return this._supportedLimits.$limits.$maxComputeWorkgroupsPerDimension.value }
  get maxStorageBuffersInVertexStage() { return this._supportedLimits.$limits.$maxStorageBuffersInVertexStage.value }
  get maxStorageTexturesInVertexStage() { return this._supportedLimits.$limits.$maxStorageTexturesInVertexStage.value }
  get maxStorageBuffersInFragmentStage() { return this._supportedLimits.$limits.$maxStorageBuffersInFragmentStage.value }
  get maxStorageTexturesInFragmentStage() { return this._supportedLimits.$limits.$maxStorageTexturesInFragmentStage.value }
}
...
class Adapter implements GPUAdapter {
  ...
  get features(): GPUSupportedFeatures {
    ...
    for (let i = 0n; i < supported_features.$featureCount.value; i++) {
      features.add(FeatureName.get(new c.FeatureName().loadFromPtr(c.Pointer.new(supported_features.$features.value + i)))!)
    }
    return features
  }
  ...
  async requestDevice(descriptor?: GPUDeviceDescriptor): Promise<GPUDevice> {
    ...
    const [dev_status, device, dev_msg] = await _run(c.RequestDeviceCallbackInfo, (cb) => c.adapterRequestDeviceF(this._adapter, dev_desc.ptr(), cb))
