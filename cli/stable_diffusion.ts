import { env, load_state_dict, Tensor, TinyJit, Tqdm } from '../jsgrad/node.ts'
...
// load in weights
const file = await env.fetchSave('https://huggingface.co/CompVis/stable-diffusion-v-1-4-original/resolve/refs%2Fpr%2F228/sd-v1-4.safetensors?download=true', 'sd-v1-4.ckpt')
